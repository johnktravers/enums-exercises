...
class SelectPatternTest < Minitest::Test
  ...
  def test_pick_words_with_three_letters
    ...
    selected = []
    words.each do |word|
        selected.push(word) if word.length == 3
    end
  ...
  def test_pick_words_ending_in_e
    ...
    selected = []
    words.each do |word|
        selected.push(word) if word[-1] == "e"
    end
  ...
  def test_pick_words_ending_in_ing
    ...
    selected = []
    words.each do |word|
        selected.push(word) if word[-3..-1] == "ing"
    end
  ...
  def test_pick_words_containing_e
    ...
    selected = []
    words.each do |word|
        selected.push(word) if word.include?("e")
    end
  ...
  def test_pick_dinosaurs
    ...
    animals.each do |animal|
        dinosaurs.push(animal) if animal.include?("saurus")
    end
  ...
  def test_pick_floats
    ...
    floats = []
    numbers.each do |number|
        floats.push(number) if number.class == Float
    end
  ...
  def test_pick_arrays
    ...
    elements.each do |element|
        arrays.push(element) if element.class == Array
    end
  ...
  def test_pick_hashes
    ...
    hashes = []
    elements.each do |element|
        hashes.push(element) if element.class == Hash
    end
